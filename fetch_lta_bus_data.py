...
def fetch_all_historical(api_key, output_file="lta_bus_od_historical.csv", months_back=24):
    """
    Fetch OD bus data for each of the last `months_back` months (skipping
...
if __name__ == "__main__":
    ...
    # months return data for the train endpoint, and the same "up to last
    # three months" wording appears in the API docs for ODBus) — default to
    # a small buffer instead of scanning far back and wasting API quota on
    # months that will never have data.
